...
## 11.1.0
- Add optional scheduled restart for `object-detector`
...
- Update `redis-writer` to 2.1.0 (updates deps and switches to `valkey-py` and `vision-lib==1.0.0`)
- Update `ai-control` to 0.1.3
